...
async def run_agent() -> None:
    ...
    async with httpx.AsyncClient(verify=SSL_VERIFY, timeout=5.0, follow_redirects=True) as client:
        if SERVER_ID == 0:
...
"@ | Set-Content -Path backend/scripts/agent_bruteforce_ddos.py -Encoding UTF8"