...
Run from project root: python scripts/generate_and_train.py
"""
...
def train(df):
    ...
    return clf, scaler, encoder, {"accuracy": acc, "f1_macro": f1, "classification_report": report}
...
def save_artifacts(clf, scaler, encoder, metrics):
    ...
    report_path = Path("reports") / "cicids2017_training_report.json"
...
if __name__ == "__main__":
    ...
    out_csv = Path("data/cicids2017_processed.csv")
